...
export async function initializeDatabase() {
  ...
  if (Number(templatesCount.rows[0]?.count || 0) === 0) {
    await sql`
      ...
      (6, 'КАДАМИ 6: НАМОИШИ ОН ЧИ МЕХОҲАМ', 
      ...
      (7, 'КАДАМИ 7: ХУЛОСАИ ҲАФТА', 
       '<p>Дар як ҳафта ман ба ояндои худ чӣ медиҳам? Медонам, ки бо یک шахси сабуксу... возможно андак дард мешавам. Бояд худро дар сатҳи зиндагӣ идора кунам!</p>')
